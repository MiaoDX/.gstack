...
Captured: 2026-04-15T02:32:57Z | Branch: dongxu/dev-0415-1 | Commit: 1123553
...
1. Should the known-bad fixture live as a checked-in image pack only, or as a full
   checked-in artifact pack with current report JSON plus images?
2. Should baseline images be copied into the trial output so the report stays
   self-contained, or should the summary embed them directly?
3. Is a tiny report-renderer hook needed to keep the current-vs-baseline block
